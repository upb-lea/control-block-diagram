...
from control_block_diagram.predefined_components import DqToAlphaBetaTransformation, Converter, PMSM,\
    ...
    DcConverter, DcPermExMotor, Divide, DcExtExMotor, IController, SCIM, Limit
...
if __name__ == '__main__':
    ...
    #stages = [torque_stage, current_stage(emf_feedforward), series_dc_stage(emf_feedforward)]
    #stages = [series_dc_stage(emf_feedforward)]
    inputs = dict()
    outputs = dict()
    connections = dict()
    connect_to_lines = dict()
