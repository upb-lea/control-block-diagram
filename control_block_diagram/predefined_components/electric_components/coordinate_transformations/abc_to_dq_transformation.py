...
class AbcToDqTransformation(CoordinateTransformation):
    """
        Coordinate transformation from abc-Coordinates to dq-Coordinates with 3 inputs and 2 outputs
    """
    ...
    def __init__(self, position, size: float = 1.5, input: str = 'left', output: str = 'right',
                 ...
                 input_space: float = 0.3, output_space: float = 0.6, *args, **kwargs):
        """
        ...
        super().__init__(position, size, r'$\mathrm{abc}$', r'$\mathrm{dq}$', input, 3, output, 2, additional_inputs,
