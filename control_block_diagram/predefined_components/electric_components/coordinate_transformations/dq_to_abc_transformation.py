...
class DqToAbcTransformation(CoordinateTransformation):
    """
        Coordinate transformation from dq-Coordinates to abc-Coordinates with 2 inputs and 3 outputs
    """
    ...
    def __init__(self, position, size: float = 1.5, input: str = 'left', output: str = 'right',
                 ...
                 input_space: float = 0.6, output_space: float = 0.3, *args, **kwargs):
        """
        ...
        super().__init__(position, size, r'$\mathrm{dq}$', r'$\mathrm{abc}$', input, 2, output, 3, additional_inputs,
