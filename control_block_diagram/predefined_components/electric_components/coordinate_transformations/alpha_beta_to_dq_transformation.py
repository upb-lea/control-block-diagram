...
class AlphaBetaToDqTransformation(CoordinateTransformation):
    """
        Coordinate transformation from alpha-beta-Coordinates to dq-Coordinates with 2 inputs and 2 outputs
    """
    ...
    def __init__(self, position, size: float = 1.5, input: str = 'left', output: str = 'right',
        ...
        super().__init__(position, size, r'$\upalpha\upbeta$', r'$\mathrm{dq}$', input, 2, output, 2,
