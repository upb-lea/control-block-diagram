...
if __name__ == '__main__':
    ...
    box_inp = Box(Point(0, 0), size=(1.5, 0.8), text=r'$R_{r} \frac{L_{m}}{L_{r}}$')
    Connection.connect(box_inp.input_left[0].sub_x(1), box_inp.input_left[0], text=r'$\underline{i}_s$',
    ...
    Connection.connect(box_int.output_right[0], box_int.output_right[0].add_x(2), text=r'$\underline{\Psi}_{r}$',
                       distance_y=0.3)
    box_back = Box(box_int.position.sub_y(1.5), size=(1.8, 0.8), text=r'$\frac{R_r}{L_r}-j \omega_{rs}$')
